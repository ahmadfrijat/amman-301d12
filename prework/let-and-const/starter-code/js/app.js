...
function displayPics(){
  ...
  // Since this example uses the let keyword, the variable rando is blocked scope. It means that the variable rando only exists and can be accessible inside the while loop block.
